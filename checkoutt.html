	...
	<body>
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">Fuck Your Feelings</a>
			</div>
				...
				<div class="col-sm-4 col-lg-3">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<img src="img/foto1-<?= $_POST['cor'] ?>.png" class="img-thumbnail img-responsive">
							<dl>
								<dt>Produto</dt>
								<dd><?= $_POST["nome"] ?></dd>
								<dt>Preço</dt>
